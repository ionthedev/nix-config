  ...
  programs.lazygit = {
    ...
    settings = {
      ...
      gui = {
        ...
        theme = {
        activeBorderColor = ["#565f89" "- bold"];
        cherryPickedCommitBgColor = ["#565f89"];
        cherryPickedCommitFgColor = ["#565f89"];
        defaultFgColor = ["#a9b1d6"];
        inactiveBorderColor = ["#1a1b26"];
        optionsTextColor = ["#9aa5ce"];
        searchingActiveBorderColor = ["#565f89" "- bold"];
        selectedLineBgColor = ["#343b58"];
        unstagedChangesColor = ["#e0af68"];
        };
      };
